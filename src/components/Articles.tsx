        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid gap-8">
            {articles.map((article, index) => (
              <div key={index} className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-md transition-all hover:shadow-lg border-l-4 border-blue-500 hover:border-blue-600\">
