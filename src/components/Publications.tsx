...
function PublicationItem({ pub }: { pub: Pub }) {
  return (
    <motion.article variants={itemVariants} className="flex gap-4">
  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="mb-6 text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500"
      >
