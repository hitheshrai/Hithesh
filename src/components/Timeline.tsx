...
const stages: Stage[] = [
  {
    ...
    yearLabel: '2022',
    institute: 'Renewable Energy Materials & Devices Lab · Undergraduate Researcher',
    location: 'Tempe, AZ',
    flag: 'us',
    region: 'us',
    narrative:
  ...
  {
    id: 'purdue-data',
    short: 'Purdue University',
    date: 'Summer 2023',
    yearLabel: '2023',
    institute: 'Letian Dou Group · Research Fellow',
  ...
  {
    id: 'structure-hzb',
    short: 'Helmholtz-Zentrum Berlin',
    date: 'Summer 2024',
    yearLabel: '2024',
    institute: 'Institute for Quantum Phenomena in Novel Materials · Visiting Researcher',
  ...
  },
  {
    ...
    date: 'Summer 2025',
    yearLabel: '2025',
    institute: 'Photovoltaics Lab, École Polytechnique Fédérale de Lausanne · Visiting Researcher',
  ...
  },
  {
    ...
    date: 'May – Aug 2026',
    yearLabel: '2026',
    institute: 'Electrochemical Smart Lab (GREEN) · Graduate Research Intern',
